---
name: lofitick-desktop-ui-design-banner
description: 'Design banners for social media, ads, website heroes, creative assets, and print. Multiple art direction options with AI-generated visuals. Actions: design, create, generate banner. Platforms: Facebook, Twitter/X, LinkedIn, YouTube, Instagram, Google Display, website hero, print. Styles: minimalist, gradient, bold typography, photo-based, illustrated, geometric, retro, glassmorphism, 3D, neon, duotone, editorial, collage. Uses ui-ux-pro-max, frontend-design, ai-artist, ai-multimodal skills. (为社交媒体、广告、网站首屏、创意资产和印刷品设计横幅；提供多个艺术方向选项，并结合 AI 生成视觉元素。适用于设计、创建、生成横幅；覆盖 Facebook、Twitter/X、LinkedIn、YouTube、Instagram、Google Display、网站首屏和印刷；支持极简、渐变、粗体排版、照片、插画、几何、复古、玻璃拟态、3D、霓虹、双色、编辑风与拼贴等风格；会使用 ui-ux-pro-max、frontend-design、ai-artist、ai-multimodal 等 skill。)'
