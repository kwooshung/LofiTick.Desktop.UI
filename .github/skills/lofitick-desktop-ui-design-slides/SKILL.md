---
name: lofitick-desktop-ui-design-slides
description: 'Comprehensive design skill: brand identity, design tokens, UI styling, logo generation (55 styles, Gemini AI), corporate identity program (50 deliverables, CIP mockups), HTML presentations (Chart.js), banner design (22 styles, social/ads/web/print), icon design (15 styles, SVG, Gemini 3.1 Pro), social photos (HTML→screenshot, multi-platform). Actions: design logo, create CIP, generate mockups, build slides, design banner, generate icon, create social photos, social media images, brand identity, design system. Platforms: Facebook, Twitter, LinkedIn, YouTube, Instagram, Pinterest, TikTok, Threads, Google Ads. (综合设计 skill：覆盖品牌识别、设计 token、UI 样式、Logo 生成（55 种风格，Gemini AI）、企业识别系统（50 种交付物，CIP 样机）、HTML 演示文稿（Chart.js）、横幅设计（22 种风格，覆盖社交、广告、网站与印刷）、图标设计（15 种风格，SVG，Gemini 3.1 Pro）以及多平台社媒图片（HTML 到截图）。适用于设计 Logo、创建 CIP、生成样机、制作幻灯片、设计横幅、生成图标、创建社媒图片、社交媒体视觉、品牌识别与设计系统；覆盖 Facebook、Twitter、LinkedIn、YouTube、Instagram、Pinterest、TikTok、Threads 和 Google Ads。)'
argument-hint: '[design-type] [context]'
license: Private
metadata:
  author: claudekit, SuttonKwok
  version: '2.1.0'
---
