<template>
  <CrawlersNodesCommonBasic icon-name="i-lucide-focus" :title="t('components.crawler.blueprint.nodes.interaction.focusElement.title')" :description="t('components.crawler.blueprint.nodes.interaction.focusElement.description')" header-bg="bg-purple-500" :right-pins="rightPins">
    <div class="space-y-3">
