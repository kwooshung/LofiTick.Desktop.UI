<template>
  <CrawlersNodesCommonBasic icon-name="i-tabler-math-lower" :title="t('components.crawler.blueprint.nodes.logic.lessThan.title')" :description="t('components.crawler.blueprint.nodes.logic.lessThan.description')" header-bg="bg-rose-500" :left-pins="leftPins" :right-pins="rightPins" />
</template>
