<template>
  <CrawlersNodesCommonBasic icon-name="i-lucide-arrow-right" :title="t('components.crawler.blueprint.nodes.navigation.forward.title')" :description="t('components.crawler.blueprint.nodes.navigation.forward.description')" header-bg="bg-blue-500" :right-pins="rightPins">
    <div class="space-y-3">
      ...
      <USwitch v-model="stateWaitReady" :label="t('components.crawler.blueprint.nodes.navigation.forward.fields.waitReady.label')" />

      <USwitch v-model="stateAllowNoHistory" :label="t('components.crawler.blueprint.nodes.navigation.forward.fields.allowNoHistory.label')" />
    </div>
