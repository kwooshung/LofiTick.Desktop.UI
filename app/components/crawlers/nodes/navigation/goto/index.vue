  ...
  >
    <div class="space-y-3">
      ...
      <div class="space-y-2">
        ...
        <UEmpty v-if="statePathVariables.length === 0" icon="i-lucide-braces" :title="t('components.crawler.blueprint.nodes.navigation.goto.fields.pathVariables.empty.title')" :description="t('components.crawler.blueprint.nodes.navigation.goto.fields.pathVariables.empty.description')">
          <template #actions>
