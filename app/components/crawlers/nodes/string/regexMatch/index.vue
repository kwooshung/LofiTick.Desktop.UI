<template>
  <CrawlersNodesCommonBasic icon-name="i-lucide-search-code" :title="t('components.crawler.blueprint.nodes.string.regexMatch.title')" :description="t('components.crawler.blueprint.nodes.string.regexMatch.description')" header-color="" header-bg="bg-teal-500" :left-pins="leftPins" :right-pins="rightPins">
    <div class="space-y-3">
...
interface IStringRegexMatchNodeData {
  text?: string;
  pattern?: string;
  flags?: string;
}
...
const leftPins: IBasicSidePin[] = [
  { id: 'input-text', label: 'text', direction: 'in', dataType: 'string', topPercent: 20, description: '待匹配的文本' },
  { id: 'input-pattern', label: 'pattern', direction: 'in', dataType: 'string', topPercent: 50, description: '正则表达式模式' },
  { id: 'input-flags', label: 'flags', direction: 'in', dataType: 'string', topPercent: 80, description: '标志(g/i/m等)' }
];

const rightPins: IBasicSidePin[] = [
  { id: 'result-array', label: 'matches', direction: 'out', dataType: 'array', topPercent: 35, description: '匹配结果数组' },
