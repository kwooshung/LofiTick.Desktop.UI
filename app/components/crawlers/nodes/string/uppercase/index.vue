<template>
  <CrawlersNodesCommonBasic icon-name="i-lucide-type" :title="t('components.crawler.blueprint.nodes.string.uppercase.title')" :description="t('components.crawler.blueprint.nodes.string.uppercase.description')" header-color="" header-bg="bg-teal-500" :left-pins="leftPins" :right-pins="rightPins">
...
import type { IStringUppercaseNodeData } from '@/components/crawlers/nodes/string/uppercase/index.types';
