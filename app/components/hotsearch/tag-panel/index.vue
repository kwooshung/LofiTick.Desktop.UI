 ...
 * API：热搜标签统计分页。
 */
const { datas, loading, refreshDebounced } = await useApi<IHotsearchTagSummaryPage>('hotsearch/tags', {
 ...
 */
const buildDataLocation = (categoryKey: string): { path: string; query: Record<string, string | undefined> } => ({
