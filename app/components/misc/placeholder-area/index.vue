<template>
  <div class="border-accented relative flex items-center justify-center overflow-hidden rounded-sm border border-dashed px-4 opacity-75">
    <svg class="stroke-inverted/10 absolute inset-0 size-full" fill="none">
      <defs>
