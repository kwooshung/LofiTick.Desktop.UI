          ...
          <div class="space-y-1">
            ...
            <span v-if="stateStoragePath">
              <UTooltip arrow :text="stateStoragePath" :content="{ side: 'top' }" :disabled="stateStoragePath === computedTruncatedStorage">
                <ULink raw class="text-muted hover:text-primary inline-flex max-w-full cursor-pointer align-middle font-normal no-underline hover:underline whitespace-normal break-all" @click="handleOpenStorage">
