  ...
  hotsearch: {
    ...
    sections: {
      schedule: {
       ...
       headMusic: {
         title: 'Fixed head music',
         description: 'Manage the podcast generation owner lock, the standard intro, and the VIP intro in one place.'
       },
      podcast: {
    ...
    fields: {
      ...
      podcastGenerateEnabled: {
        label: 'Generate podcast on this machine',
        description: 'When enabled, only this machine may generate hot search podcasts. The app checks the fixed head-music files and owner lock before turning it on.'
      },
      podcastHeadMusicNormal: {
        label: 'Standard head music',
        description: 'Stored at attachmentsDir/media/podcast/hotsearch/start.mp3 and mirrored to UpYun.'
      },
      podcastHeadMusicVip: {
        label: 'VIP head music',
        description: 'Stored at attachmentsDir/media/podcast/hotsearch/start.vip.mp3 and mirrored to UpYun.'
      },
    ...
    actions: {
      ...
      syncHeadMusic: 'Sync from cloud',
      chooseAttachmentsDir: 'Choose attachments directory'
    },
    labels: {
      headMusicPath: 'Fixed path'
    },
    status: {
      ...
      podcastGenerateOwnerIdleDescription: 'Only one machine may enable podcast generation at a time. The app will verify cloud head-music files and fill missing local files first.',
      podcastGenerateOwnedByCurrentMachineDescription: 'This machine is currently responsible for podcast generation. Machine: {machineName}; code: {machineCode}.',
      podcastGenerateOwnedByOtherMachineDescription: 'Another machine is currently responsible for podcast generation. Machine: {machineName}; code: {machineCode}.',
      headMusicWaitingTitle: 'Fixed head music is not ready yet',
      headMusicNeedAttachmentsDir: 'Choose the attachments directory first so the fixed head-music file can be written to the required path on this machine.',
      headMusicNeedUpload: 'This fixed head-music file does not exist in cloud storage yet. Upload it first so other machines can sync it directly.',
      headMusicNeedSync: 'The fixed head-music file already exists in cloud storage, but it has not been written locally on this machine yet. You can sync it now.',
      headMusicNeedPreview: 'The file exists, but a playable preview URL is not available yet.'
    },
    dialogs: {
      attachmentsDirRequired: {
        title: 'Attachments directory is required',
        description: 'Fixed head-music files must be saved under the attachments directory. Choose the directory first, then enable podcast generation or upload music again.'
      },
      headMusicUpload: {
        title: 'Upload {title}',
        ...
        currentPreview: 'Current online preview',
        pendingPreview: 'Pending upload preview',
        uploadProgress: 'Upload progress'
      }
    },
    messages: {
      podcastGenerateErrorTitle: 'Podcast generation unavailable',
      podcastHeadMusicErrorTitle: 'Head music operation failed',
      machineCodeMissing: 'The current machine code is missing, so the owner lock cannot be claimed.',
      podcastGenerateOwnerConflict: 'Podcast generation is already enabled on another machine: {machineName} ({machineCode}).',
      podcastGenerateHeadMusicMissing: 'The standard or VIP head-music file is still missing in cloud storage, so podcast generation cannot be enabled yet.',
      podcastHeadMusicRemoteMissing: 'The fixed head-music file does not exist in cloud storage yet.',
      podcastHeadMusicDownloadFailed: 'Failed to download the fixed head-music file from cloud storage.',
      podcastHeadMusicUploadFailed: 'Failed to upload the fixed head-music file.'
    },
    variables: {
