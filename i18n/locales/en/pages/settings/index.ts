export const settings = {
  ...
  hotsearch: {
    ...
    sections: {
      ...
      podcastRules: {
        title: 'Podcast rules',
        description: 'Maintain Markdown rules used only by AI here so you can constrain tone, structure, and forbidden patterns.'
      },
      platforms: {
        title: 'Platforms',
    ...
    fields: {
      ...
      podcastGenerateEnabled: {
        ...
        description: 'When enabled, only this machine may generate hot search podcasts. The app checks local head-music files first and only falls back to cloud repair when needed.'
      },
      podcastHeadMusicNormal: {
        label: 'Head music (Standard)',
        description: 'Intro music for the standard podcast.'
      },
      podcastHeadMusicVip: {
        label: 'Head music (VIP)',
        description: 'Intro music for the VIP podcast.'
      },
    ...
    status: {
      ...
      podcastGenerateOwnerIdleDescription: 'Only one machine may enable podcast generation at a time. The app checks local head-music files first and only repairs from cloud storage when needed.',
      ...
      headMusicReady: 'Both local and cloud copies are ready. You can preview, sync, or upload again now.',
    ...
    dialogs: {
      attachmentsDirRequired: {
        ...
        description: 'Head-music files must be saved under the attachments directory. Choose the directory first, then enable podcast generation or upload music again.'
      },
      headMusicUpload: {
        title: 'Upload {title}',
    ...
    messages: {
      ...
      podcastGenerateHeadMusicMissing: 'The standard or VIP head-music file is not ready yet, so podcast generation cannot be enabled.',
      podcastGenerateHeadMusicMissingToast: '{titles} is missing locally and in cloud storage. Please choose music first.',
      podcastHeadMusicRemoteMissing: 'The head-music file does not exist in cloud storage yet.',
      podcastHeadMusicDownloadFailed: 'Failed to download the head-music file from cloud storage.',
      podcastHeadMusicUploadFailed: 'Failed to upload the head-music file.'
    },
    variables: {
